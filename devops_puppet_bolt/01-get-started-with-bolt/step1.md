...
`yum install -y git && git clone https://github.com/tjozsa/katacoda-scenarios && cd katacoda-scenarios/devops_puppet_bolt/master-course-data/assets/tools/`{{execute}}
